...
<link rel="stylesheet" href="<?php echo $homeUrl; ?>/css/<?php echo ( !empty($css) ) ? $css : "default.css"; ?>" />
<?php $this->display("_parts/google_analytics.php"); ?>
<script>
...
<script src="<?php echo $homeUrl; ?>/js/<?php echo ( !empty($js) ) ? $js : "default.js"; ?>"></script>
</body>
</html>
